    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <section className="mb-8 grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          <div key={item.label} className="bg-white/5 backdrop-blur-sm border border-bluetti-border rounded-xl px-4 py-5 flex flex-col items-center gap-3 text-center">
            {item.icon}
